...
{
	uint32_t Release; // release time (tuning factor with no specific units)
	uint32_t Loudness; // loudness target (threshold)
...
FX_API_(HRESULT)
CreateFX(REFCLSID clsid, __deref_out IUnknown** pEffect);
