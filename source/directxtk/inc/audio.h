...
inline AUDIO_ENGINE_FLAGS
operator|(AUDIO_ENGINE_FLAGS a, AUDIO_ENGINE_FLAGS b)
{
...
inline SOUND_EFFECT_INSTANCE_FLAGS
operator|(SOUND_EFFECT_INSTANCE_FLAGS a, SOUND_EFFECT_INSTANCE_FLAGS b)
{
