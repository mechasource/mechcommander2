...
public:
	RenderTargetState() noexcept :
		sampleMask(~0U), numRenderTargets(0), rtvFormats{}, dsvFormat(DXGI_FORMAT_UNKNOWN), sampleDesc{}, nodeMask(0)
	{
	}
	...
	RenderTargetState(
		...
		sampleMask(UINT_MAX),
		numRenderTargets(1), rtvFormats{}, dsvFormat(dsFormat), sampleDesc{}, nodeMask(0)
	{
		sampleDesc.Count = 1;
