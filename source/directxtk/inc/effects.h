...
public:
	...
	virtual size_t __cdecl CreateTexture(_In_ std::wstring_view texturename, int32_t descriptorindex) = 0;
...
public:
	...
	size_t __cdecl CreateTexture(_In_ std::wstring_view texturename, int32_t descriptorindex) override;
	...
	void __cdecl SetDirectory(_In_opt_ std::wstring_view pathname) noexcept;
