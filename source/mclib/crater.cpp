...
float craterUVTable[136] = {
	0.000, 0.000, // Anubis
	0.125, 0.000, 0.250, 0.000, // Atlas
	0.375, 0.000, 0.500, 0.000, // BloodAsp
	0.625, 0.000, 0.750, 0.000, // Bushwacker
	0.875, 0.000, 0.000, 0.125, // Catapult
	0.125, 0.125, 0.250, 0.125, // Cougar
	0.375, 0.125, 0.500, 0.125, // Cyclops
	0.625, 0.125, 0.750, 0.125, // Enfield
	0.875, 0.125, 0.000, 0.250, // Flea (fireant)
	0.125, 0.250, 0.250, 0.250, // highlander
	0.375, 0.250, 0.500, 0.250, // hollander
	0.625, 0.250, 0.750, 0.250, // hunchback
	0.875, 0.250, 0.000, 0.375, // jaegermech
	0.125, 0.375, 0.250, 0.375, // laohu
	0.375, 0.375, 0.500, 0.375, // madcat
	0.625, 0.375, 0.750, 0.375, // menshen
	0.875, 0.375, 0.000, 0.500, // Raven
	0.125, 0.500, 0.250, 0.500, // Ryoken
	0.375, 0.500, 0.500, 0.500, // Shadowcat
	0.625, 0.500, 0.750, 0.500, // Shayu
	0.875, 0.500, 0.000, 0.625, // Shootist
	0.125, 0.625, 0.250, 0.625, // Starslayer
	0.375, 0.625, 0.500, 0.625, // thor
	0.625, 0.625, 0.750, 0.625, // Uller
	0.875, 0.625, 0.000, 0.750, // Urbanmech
	0.125, 0.750, 0.250, 0.750, // Vulture
	0.375, 0.750, 0.500, 0.750, // Werewolf (razorback)
	0.625, 0.750, 0.750, 0.750, // Wolfhound
	0.875, 0.750, 0.000, 0.875, // Zeus
	0.125, 0.875, 0.0, 0.0, // CRATER_1,
	0.50, 0.0, // CRATER_2,
	0.0, 0.50, // CRATER_3,
	0.50, 0.50 // CRATER_4,
};
...
//---------------------------------------------------------------------
int32_t
CraterManager::addCrater(int32_t craterType, Stuff::Vector3D& position, float rotation)
{
	...
	if (drawMe)
	{
		...
		craterList[currentCrater].position[1].z =
			land->getTerrainElevation(craterList[currentCrater].position[1]);
		craterList[currentCrater].position[2].z =
			land->getTerrainElevation(craterList[currentCrater].position[2]);
		craterList[currentCrater].position[3].z =
			land->getTerrainElevation(craterList[currentCrater].position[3]);
		currentCrater++;
...
CraterManager::update(void)
{
	...
	for (size_t i = 0; i < (int32_t)maxCraters; i++, currentCrater++)
	{
...
void CraterManager::render(void)
{
	...
	for (size_t i = 0; i < (int32_t)maxCraters; i++, currCrater++)
	{
