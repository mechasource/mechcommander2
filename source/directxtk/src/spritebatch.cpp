...
_Use_decl_annotations_ void XM_CALLCONV SpriteBatch::Impl::Begin(
...
_Use_decl_annotations_ void XM_CALLCONV SpriteBatch::Impl::Draw(D3D12_GPU_DESCRIPTOR_HANDLE texture,
	DirectX::XMUINT2 const& textureSize,
	DirectX::FXMVECTOR destination,
...
_Use_decl_annotations_ void SpriteBatch::Impl::RenderBatch(D3D12_GPU_DESCRIPTOR_HANDLE texture, DirectX::XMVECTOR textureSize, SpriteInfo const* const* sprites, size_t count)
{
	auto commandList = mCommandList.get();
...
_Use_decl_annotations_ void XM_CALLCONV SpriteBatch::Impl::RenderSprite(SpriteInfo const* sprite, VertexPositionColorTexture* vertices, DirectX::FXMVECTOR textureSize, DirectX::FXMVECTOR inverseTextureSize) noexcept
{
...
_Use_decl_annotations_ void XM_CALLCONV SpriteBatch::Begin(
	ID3D12GraphicsCommandList* commandList,
	SpriteSortMode sortMode,
	DirectX::FXMMATRIX transformMatrix)
{
...
_Use_decl_annotations_ void XM_CALLCONV SpriteBatch::Draw(D3D12_GPU_DESCRIPTOR_HANDLE texture,
	DirectX::XMUINT2 const& textureSize,
	DirectX::XMFLOAT2 const& position,
	RECT const* sourceRectangle,
	DirectX::FXMVECTOR color,
