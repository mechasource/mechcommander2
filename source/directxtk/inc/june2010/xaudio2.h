...
DECLARE_INTERFACE_(IXAudio2, IUnknown)
{
    ...
    //
    STDMETHOD(GetDeviceCount) (THIS_ __out uint32_t* pCount) PURE;
    ...
    //
    STDMETHOD(GetDeviceDetails) (THIS_ uint32_t Index, __out XAUDIO2_DEVICE_DETAILS* pDeviceDetails) PURE;
    ...
    //
    STDMETHOD(Initialize) (THIS_ uint32_t flags X2DEFAULT(0),
    ...
    //
    STDMETHOD(CommitChanges) (THIS_ uint32_t OperationSet) PURE;
...
DECLARE_INTERFACE(IXAudio2Voice)
{
    ...
    */\
    STDMETHOD(EnableEffect) (THIS_ uint32_t EffectIndex, \
    ...
    //  OperationSet - Used to identify this call as part of a deferred batch.
    */\
    STDMETHOD(DisableEffect) (THIS_ uint32_t EffectIndex, \
                              uint32_t OperationSet X2DEFAULT(XAUDIO2_COMMIT_NOW)) PURE; \
    \
    ...
    */\
    STDMETHOD_(void, GetEffectState) (THIS_ uint32_t EffectIndex, __out BOOL* pEnabled) PURE; \
    \
    ...
    //  OperationSet - Used to identify this call as part of a deferred batch.
    */\
    STDMETHOD(SetEffectParameters) (THIS_ uint32_t EffectIndex, \
    ...
    //  ParametersByteSize - Size of the pParameters array in bytes.
    */\
    STDMETHOD(GetEffectParameters) (THIS_ uint32_t EffectIndex, \
    ...
    */\
    ...
    //  OperationSet - Used to identify this call as part of a deferred batch.
    */\
    STDMETHOD(SetChannelVolumes) (THIS_ uint32_t Channels, __in_ecount(Channels) const float* pVolumes, \
                                  uint32_t OperationSet X2DEFAULT(XAUDIO2_COMMIT_NOW)) PURE; \
    \
    ...
    */\
    STDMETHOD_(void, GetChannelVolumes) (THIS_ uint32_t Channels, __out_ecount(Channels) float* pVolumes) PURE; \
    \
...
DECLARE_INTERFACE_(IXAudio2SourceVoice, IXAudio2Voice)
{
    ...
    //  OperationSet - Used to identify this call as part of a deferred batch.
    //
    STDMETHOD(Start) (THIS_ uint32_t flags X2DEFAULT(0), uint32_t OperationSet X2DEFAULT(XAUDIO2_COMMIT_NOW)) PURE;
    ...
    //  OperationSet - Used to identify this call as part of a deferred batch.
    //
    STDMETHOD(Stop) (THIS_ uint32_t flags X2DEFAULT(0), uint32_t OperationSet X2DEFAULT(XAUDIO2_COMMIT_NOW)) PURE;
    ...
    //  OperationSet - Used to identify this call as part of a deferred batch.
    //
    STDMETHOD(ExitLoop) (THIS_ uint32_t OperationSet X2DEFAULT(XAUDIO2_COMMIT_NOW)) PURE;
    ...
    //
    STDMETHOD(SetSourceSampleRate) (THIS_ uint32_t NewSourceSampleRate) PURE;
};
...
DECLARE_INTERFACE(IXAudio2VoiceCallback)
{
    ...
    STDMETHOD_(void, OnVoiceProcessingPassStart) (THIS_ uint32_t BytesRequired) PURE;
