...
Stuff::MemoryStream& Read(
	Stuff::MemoryStream* stream, Stuff::MStringRepresentation* str);
Stuff::MemoryStream& Write(
	Stuff::MemoryStream* stream, const Stuff::MStringRepresentation& str);
Stuff::MemoryStream& Read(Stuff::MemoryStream* stream, Stuff::MString* str);
Stuff::MemoryStream& Write(
	Stuff::MemoryStream* stream, const Stuff::MString* str);
}
...
#endif
{
	...
	friend MemoryStream& MemoryStreamIO::Read(
		MemoryStream* stream, MString* str);
  ...
  private:
	...
	//
	friend MStringRepresentation operator+(
		const MStringRepresentation& str1, const MStringRepresentation& str2);

	friend MStringRepresentation operator+(
		const MStringRepresentation& str1, char ch);

	void operator+=(const MStringRepresentation& str);
	void operator+=(char ch);

	//
	// comparison methods
	//
	int32_t Compare(const MStringRepresentation& str) const;

	bool operator<(const MStringRepresentation& str) const;
	bool operator>(const MStringRepresentation& str) const;
	bool operator<=(const MStringRepresentation& str) const;
	bool operator>=(const MStringRepresentation& str) const;
	bool operator==(const MStringRepresentation& str) const;
	...
	bool operator==(PCSTR cstr) const;
	...
	MStringRepresentation GetNthToken(
		size_t nth_token, PSTR delimiters = nullptr) const;
	...
	//
#if !defined(Spew)
	friend void ::Spew(PCSTR group, const MStringRepresentation& string);
#endif

	friend MemoryStream& MemoryStreamIO::Read(
		MemoryStream* stream, MStringRepresentation* str);

	friend MemoryStream& MemoryStreamIO::Write(
		MemoryStream* stream, const MStringRepresentation& str);

	friend void Convert_From_Ascii(PCSTR str, MStringRepresentation* value);

	IteratorPosition GetHashValue(void);
...
inline size_t MStringRepresentation::GetLength(void) const
{
	// Check_Object(this);
	Verify((stringText != nullptr) ? (stringLength == strlen(stringText))
								   : (stringLength == 0));
	return stringLength;
}

inline void MStringRepresentation::SetLength(size_t length)
{
	// Check_Object(this);
...
inline size_t MStringRepresentation::GetSize(void) const
{
	// Check_Object(this);
	return stringSize;
}
...
// create a c-string from MStringRepresentation method
// HACK - ECH 11/1/95 - Remove const to support 3rd party libs
inline MStringRepresentation::operator PSTR(void) const
{
	// Check_Object(this);
...
// concatenation methods
inline void MStringRepresentation::operator+=(const MStringRepresentation& str)
{
	// Check_Object(this);
	*this = *this + str;
}

inline void MStringRepresentation::operator+=(char ch)
{
	// Check_Object(this);
	*this = *this + ch;
}
...
// comparison methods
inline bool MStringRepresentation::operator<(
	const MStringRepresentation& str) const
{
...
inline bool MStringRepresentation::operator==(PCSTR cstr) const
{
	return (Compare(cstr) == 0);
}

// character retrieval method
inline char MStringRepresentation::operator[](size_t pos) const
{
	// Check_Object(this);
...
// Reference count methods
inline void MStringRepresentation::IncrementReferenceCount()
{
	// Check_Object(this);
...
inline void MStringRepresentation::DecrementReferenceCount()
{
	// Check_Object(this);
	Verify(referenceCount > 0);
	if (--referenceCount == 0)
...
inline IteratorPosition MStringRepresentation::GetHashValue()
{
	...
	for (i = 0; i < len; i++)
	{
		...
		_asm mov ecx, i _asm ror r, cl ret += r;
	}
	ret += stringLength & 0x3
			   ? ((size_t*)stringText)[i] & andAway[stringLength & 0x3 - 1]
			   : 0;
...
#endif
{
  ...
  public:
	...
	friend bool Close_Enough(PCSTR str1, PCSTR str2, float e = SMALL);
	...
	// comparison methods
	//
	int32_t Compare(const MString& str) const;
	...
	MString GetNthToken(size_t nth_token, PSTR delimiters = nullptr) const;
	...
	//
#if !defined(Spew)
	friend void ::Spew(PCSTR group, const MString& string);
#endif
	...
	friend MemoryStream& MemoryStreamIO::Write(
		MemoryStream* stream, const MString* str);

	friend void Convert_From_Ascii(PCSTR str, MString* value);

	IteratorPosition GetHashValue(void) const
	{
		return representation->GetHashValue();
	}

	friend IteratorPosition GetHashFunctions::GetHashValue(
		const MString& value);
	...
	//
  private:
	MStringRepresentation* representation;
};
...
inline MString::MString(PCSTR cstr)
{
...
inline void MString::TestInstance(void) const { Check_Object(representation); }

// length, size
inline size_t MString::GetLength(void) const
{
	Check_Object(representation);
	return representation->GetLength();
}

inline void MString::SetLength(size_t length)
{
	Check_Object(representation);
	representation->SetLength(length);
}

inline void MString::AllocateLength(size_t length)
{
	Check_Object(representation);
	representation->AllocateLength(length);
}

inline size_t MString::GetSize(void) const
{
	Check_Object(representation);
...
// create a c-string from MString method
// HACK - ECH 11/1/95 - Remove const to support 3rd party libs
inline MString::operator PSTR(void) const
{
	Check_Object(representation);
...
inline MString operator+(const MString& str1, char ch)
{
	Check_Object(&str1);
...
inline void MString::operator+=(const MString& str)
{
	// Check_Object(this);
	Check_Object(&str);
	*this = *this + str;
...
inline void MString::operator+=(char ch)
{
	// Check_Object(this);
	*this = *this + ch;
}
...
// comparison methods
inline int32_t MString::Compare(const MString& str) const
{
	Check_Object(&str);
	Check_Object(representation);
...
inline bool MString::operator<(const MString& str) const
{
	return (Compare(str) < 0);
}
...
inline bool MString::operator==(PCSTR cstr) const
{
	return (Compare(cstr) == 0);
}

// character retrieval method
inline char MString::operator[](size_t pos) const
{
	Check_Object(representation);
	return (*representation)[pos];
}

inline MString MString::GetNthToken(size_t nth_token, PSTR delimiters) const
{
	Check_Object(representation);
...
// stream input/output methods
#if !defined(Spew)
inline void Spew(PCSTR group, const Stuff::MStringRepresentation& string)
{
	Check_Object(&string);
	SPEW((group, string.stringText));
}

inline void Spew(PCSTR group, const Stuff::MString& string)
{
	Check_Object(&string);
