...
_Use_decl_annotations_
	HRESULT
	directxtk::LoadDDSTextureFromMemory(
...
_Use_decl_annotations_
	HRESULT
	directxtk::LoadDDSTextureFromMemoryEx(
		ID3D12Device* d3dDevice,
		const uint8_t* ddsData,
		size_t ddsDataSize,
		size_t maxsize,
...
_Use_decl_annotations_
	HRESULT
	directxtk::LoadDDSTextureFromFile(
		ID3D12Device* d3dDevice,
...
_Use_decl_annotations_
	HRESULT
	directxtk::LoadDDSTextureFromFileEx(
		ID3D12Device* d3dDevice,
		std::wstring_view filename,
		size_t maxsize,
		D3D12_RESOURCE_FLAGS resFlags,
...
_Use_decl_annotations_
	HRESULT
	directxtk::CreateDDSTextureFromMemory(
		ID3D12Device* d3dDevice,
...
_Use_decl_annotations_
	HRESULT
	directxtk::CreateDDSTextureFromMemoryEx(
		ID3D12Device* d3dDevice,
		ResourceUploadBatch& resourceUpload,
		const uint8_t* ddsData,
		size_t ddsDataSize,
...
_Use_decl_annotations_
	HRESULT
	directxtk::CreateDDSTextureFromFileEx(
		ID3D12Device* d3dDevice,
		ResourceUploadBatch& resourceUpload,
		std::wstring_view filename,
		size_t maxsize,
