...
int
PBREffect::Impl::GetPipelineStatePermutation(bool velocityEnabled, bool biasedVertexNormals) const
{
	int permutation = 0;
...
void
PBREffect::Impl::Apply(_In_ ID3D12GraphicsCommandList* commandList)
{
...
// IEffect methods.
void
PBREffect::Apply(_In_ ID3D12GraphicsCommandList* commandList)
{
...
// Camera settings.
void XM_CALLCONV
PBREffect::SetWorld(FXMMATRIX value)
{
...
void XM_CALLCONV
PBREffect::SetView(FXMMATRIX value)
{
...
void XM_CALLCONV
PBREffect::SetProjection(FXMMATRIX value)
{
...
void XM_CALLCONV
PBREffect::SetMatrices(FXMMATRIX world, CXMMATRIX view, CXMMATRIX projection)
{
...
void
PBREffect::SetLightEnabled(int whichLight, bool value)
{
...
void XM_CALLCONV
PBREffect::SetLightDirection(int whichLight, FXMVECTOR value)
{
	EffectLights::ValidateLightIndex(whichLight);
...
// PBR Settings
void
PBREffect::SetAlpha(float value)
{
...
void
PBREffect::SetConstantAlbedo(FXMVECTOR value)
{
...
void
PBREffect::SetConstantMetallic(float value)
{
...
void
PBREffect::SetConstantRoughness(float value)
{
...
// Texture settings.
void
PBREffect::SetAlbedoTexture(D3D12_GPU_DESCRIPTOR_HANDLE srvDescriptor, D3D12_GPU_DESCRIPTOR_HANDLE samplerDescriptor)
{
...
void
PBREffect::SetNormalTexture(D3D12_GPU_DESCRIPTOR_HANDLE srvDescriptor)
{
	pImpl->descriptors[Impl::RootParameterIndex::NormalTexture] = srvDescriptor;
}

void
PBREffect::SetRMATexture(D3D12_GPU_DESCRIPTOR_HANDLE srvDescriptor)
{
	pImpl->descriptors[Impl::RootParameterIndex::RMATexture] = srvDescriptor;
}

void
PBREffect::SetEmissiveTexture(D3D12_GPU_DESCRIPTOR_HANDLE srvDescriptor)
{
