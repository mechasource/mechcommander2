...
_Use_decl_annotations_ void XM_CALLCONV EffectFog::SetConstants(int32_t& dirtyFlags, DirectX::FXMMATRIX worldView, DirectX::XMVECTOR& fogVectorConstant)
{
	if (enabled)
	{
...
_Use_decl_annotations_ void EffectLights::SetConstants(int32_t& dirtyFlags, EffectMatrices const& matrices, DirectX::XMMATRIX& worldConstant, DirectX::XMVECTOR worldInverseTransposeConstant[3], DirectX::XMVECTOR& eyePositionConstant, DirectX::XMVECTOR& diffuseColorConstant, DirectX::XMVECTOR& emissiveColorConstant, bool lightingEnabled)
{
	if (lightingEnabled)
	{
...
_Use_decl_annotations_
	int32_t XM_CALLCONV
	EffectLights::SetLightDiffuseColor(int32_t whichLight, DirectX::FXMVECTOR value, DirectX::XMVECTOR* lightDiffuseConstant)
{
	ValidateLightIndex(whichLight);
...
_Use_decl_annotations_
	int32_t XM_CALLCONV
	EffectLights::SetLightSpecularColor(int32_t whichLight, DirectX::FXMVECTOR value, DirectX::XMVECTOR* lightSpecularConstant)
{
	ValidateLightIndex(whichLight);
