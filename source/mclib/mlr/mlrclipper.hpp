...
class MLRClipper : public Stuff::RegisteredClass
{
  public:
	...
	const Stuff::LinearMatrix4D& GetCameraToWorldMatrix(void)
	{
		// Check_Object(this);
		return cameraToWorldMatrix;
	}
	const Stuff::LinearMatrix4D& GetWorldToCameraMatrix(void)
	{
		// Check_Object(this);
		return worldToCameraMatrix;
	}
	const Stuff::Matrix4D& GetCameraToClipMatrix(void)
	{
		// Check_Object(this);
