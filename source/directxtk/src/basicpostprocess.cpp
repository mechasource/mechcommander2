...
inline float
GaussianDistribution(float x, float y, float rho)
{
...
void
BasicPostProcess::Impl::Process(_In_ ID3D12GraphicsCommandList* commandList)
{
...
void
BasicPostProcess::Impl::DownScale2x2()
{
	mUseConstants = true;
...
void
BasicPostProcess::Impl::DownScale4x4()
{
	mUseConstants = true;
...
void
BasicPostProcess::Impl::GaussianBlur5x5(float multiplier)
{
	mUseConstants = true;
...
void
BasicPostProcess::Impl::Bloom(bool horizontal, float size, float brightness)
{
	mUseConstants = true;
...
void
BasicPostProcess::Process(_In_ ID3D12GraphicsCommandList* commandList)
{
...
// Properties
void
BasicPostProcess::SetSourceTexture(D3D12_GPU_DESCRIPTOR_HANDLE srvDescriptor, _In_opt_ ID3D12Resource* resource)
{
...
void
BasicPostProcess::SetGaussianParameter(float multiplier)
{
...
void
BasicPostProcess::SetBloomExtractParameter(float threshold)
{
...
void
BasicPostProcess::SetBloomBlurParameters(bool horizontal, float size, float brightness)
{
