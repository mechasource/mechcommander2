...
class MLR_I_L_TMesh : public MLR_I_C_TMesh
{
	//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	// Initialization
	//
public:
	...
	//
protected:
	MLR_I_L_TMesh(ClassData* class_data, std::iostream stream, uint32_t version);
	~MLR_I_L_TMesh(void);

public:
	MLR_I_L_TMesh(ClassData* class_data = MLR_I_L_TMesh::DefaultData);

	static MLR_I_L_TMesh* Make(std::iostream stream, uint32_t version);
...
MLRShape* CreateIndexedTriIcosahedron_Color_Lit(IcoInfo&, MLRState*);
} // namespace MidLevelRenderer
#endif
