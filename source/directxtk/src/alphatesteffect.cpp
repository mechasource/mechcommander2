...
AlphaTestEffect::Impl::GetPipelineStatePermutation(bool vertexColorEnabled) const
{
	...
	if (mAlphaFunction == D3D12_COMPARISON_FUNC_EQUAL || mAlphaFunction == D3D12_COMPARISON_FUNC_NOT_EQUAL)
	{
		permutation += 4;
	}
...
void
AlphaTestEffect::Impl::Apply(_In_ ID3D12GraphicsCommandList* commandList)
{
...
// IEffect methods
void
AlphaTestEffect::Apply(_In_ ID3D12GraphicsCommandList* commandList)
{
...
// Camera settings
void XM_CALLCONV
AlphaTestEffect::SetWorld(FXMMATRIX value)
{
...
void XM_CALLCONV
AlphaTestEffect::SetView(FXMMATRIX value)
{
...
void XM_CALLCONV
AlphaTestEffect::SetProjection(FXMMATRIX value)
{
...
void XM_CALLCONV
AlphaTestEffect::SetMatrices(FXMMATRIX world, CXMMATRIX view, CXMMATRIX projection)
{
...
void
AlphaTestEffect::SetAlpha(float value)
{
...
// Fog settings.
void
AlphaTestEffect::SetFogStart(float value)
{
...
void
AlphaTestEffect::SetFogEnd(float value)
{
	pImpl->fog.end = value;
...
// Texture settings.
void
AlphaTestEffect::SetTexture(D3D12_GPU_DESCRIPTOR_HANDLE srvDescriptor, D3D12_GPU_DESCRIPTOR_HANDLE samplerDescriptor)
{
...
void
AlphaTestEffect::SetReferenceAlpha(int value)
{
