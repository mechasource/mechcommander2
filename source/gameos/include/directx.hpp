...
// IDirect3DDevice7
//#ifdef LAB_ONLY
HRESULT __stdcall wDrawPrimitive(LPDIRECT3DDEVICE7 d3dDevice7, D3DPRIMITIVETYPE dptPrimitiveType, uint32_t dvtVertexType, PVOID lpvVertices, uint32_t dwVertexCount, uint32_t dwFlags );
HRESULT __stdcall wDrawIndexedPrimitive(LPDIRECT3DDEVICE7 d3dDevice7, D3DPRIMITIVETYPE d3dptPrimitiveType, uint32_t dwVertexTypeDesc, PVOID pvVertices, uint32_t dwVertexCount, puint16_t pwIndices, uint32_t dwIndexCount, uint32_t dwFlags );
//#else
...
//#endif
HRESULT __stdcall wDrawPrimitiveVB(LPDIRECT3DDEVICE7 d3dDevice7, D3DPRIMITIVETYPE d3dptPrimitiveType, LPDIRECT3DVERTEXBUFFER7 lpd3dVertexBuffer, uint32_t dwStartVertex, uint32_t dwNumVertices, uint32_t dwFlags );
HRESULT __stdcall wDrawIndexedPrimitiveVB(LPDIRECT3DDEVICE7 d3dDevice7, D3DPRIMITIVETYPE d3dptPrimitiveType, LPDIRECT3DVERTEXBUFFER7 lpd3dVertexBuffer, uint32_t dwStartVertex, uint32_t dwNumVertices, puint16_t lpwIndices, uint32_t dwIndexCount, uint32_t dwFlags );
...
HRESULT __stdcall wSetRenderState(LPDIRECT3DDEVICE7 d3dDevice7, D3DRENDERSTATETYPE dwRenderStateType, uint32_t dwRenderState );
...
HRESULT __stdcall wSetTexture(LPDIRECT3DDEVICE7 d3dDevice7, uint32_t dwStage, LPDIRECTDRAWSURFACE7 lpTexture );
HRESULT __stdcall wSetTextureStageState(LPDIRECT3DDEVICE7 d3dDevice7, uint32_t dwStage, D3DTEXTURESTAGESTATETYPE dwState, uint32_t dwValue );
HRESULT __stdcall wValidateDevice(LPDIRECT3DDEVICE7 d3dDevice7, puint32_t pExtraPasses );
HRESULT __stdcall wLoad(LPDIRECT3DDEVICE7 d3dDevice7, LPDIRECTDRAWSURFACE7 lpDestTex, LPPOINT lpDestPoint, LPDIRECTDRAWSURFACE7 lpSrcTex, LPRECT lprcSrcRect, uint32_t dwFlags );
HRESULT __stdcall wSetViewport(LPDIRECT3DDEVICE7 d3dDevice7, LPD3DVIEWPORT7 lpViewport );
HRESULT __stdcall wClear(LPDIRECT3DDEVICE7 d3dDevice7, uint32_t dwCount, LPD3DRECT lpRects, uint32_t dwFlags, uint32_t dwColor, D3DVALUE dvZ, uint32_t dwStencil );
...
HRESULT __stdcall wCreateVertexBuffer(LPDIRECT3D7 d3d7, LPD3DVERTEXBUFFERDESC lpVBDesc, LPDIRECT3DVERTEXBUFFER7* lplpD3DVertexBuffer, uint32_t dwFlags );

// IDirect3DVertexBuffer7
HRESULT __stdcall wLock(LPDIRECT3DVERTEXBUFFER7 D3Dvb7, uint32_t dwFlags, PVOID* plpData, puint32_t pdwSize );
HRESULT __stdcall wUnlock(LPDIRECT3DVERTEXBUFFER7 D3Dvb7 );
HRESULT __stdcall wOptimize(LPDIRECT3DVERTEXBUFFER7 D3Dvb7, LPDIRECT3DDEVICE7 lpD3DDevice, uint32_t dwFlags );
HRESULT __stdcall wProcessVertices(LPDIRECT3DVERTEXBUFFER7 D3Dvb7, uint32_t dwVertexOp, uint32_t dwDestIndex, uint32_t dwCount, LPDIRECT3DVERTEXBUFFER7 lpSrcBuffer, uint32_t dwSrcIndex, LPDIRECT3DDEVICE7 lpD3DDevice, uint32_t dwFlags );
...
HRESULT __stdcall wSetColorKey( LPDIRECTDRAWSURFACE7 lpdd3, uint32_t dwFlags, LPDDCOLORKEY lpDDColorKey );
HRESULT __stdcall wLock( LPDIRECTDRAWSURFACE7 lpdd7, LPRECT lpDestRect, LPDDSURFACEDESC2 lpDDSurfaceDesc, uint32_t dwFlags, HANDLE hEvent );
HRESULT __stdcall wUnlock( LPDIRECTDRAWSURFACE7 lpdds7, LPRECT lprect );
HRESULT __stdcall wLock(LPDIRECTDRAWSURFACE lpdds, LPRECT lpDestRect, LPDDSURFACEDESC lpDDSurfaceDesc, uint32_t dwFlags, HANDLE hEvent );
...
HRESULT __stdcall wBlt( LPDIRECTDRAWSURFACE7 lpdd7, LPRECT lpDestRect, LPDIRECTDRAWSURFACE7 lpDDSrcSurface, LPRECT lpSrcRect, uint32_t dwFlags, LPDDBLTFX lpDDBltFx );
HRESULT __stdcall wBltFast( LPDIRECTDRAWSURFACE7 lpdd7, uint32_t dwX, uint32_t dwY, LPDIRECTDRAWSURFACE7 lpDDSrcSurface, LPRECT lpSrcRect, uint32_t dwTrans );
HRESULT __stdcall wFlip( LPDIRECTDRAWSURFACE7 lpdd7, LPDIRECTDRAWSURFACE7 lpDDSurfaceTargetOverride, uint32_t dwFlags );
...
HRESULT __stdcall wDeleteAttachedSurface( LPDIRECTDRAWSURFACE7 lpdds7, uint32_t dwFlags, LPDIRECTDRAWSURFACE7 lpDDSAttachedSurface );
HRESULT __stdcall wSetClipper( LPDIRECTDRAWSURFACE7 lpdd7, LPDIRECTDRAWCLIPPER lpDDClipper );

HRESULT __stdcall wGetDeviceIdentifier(LPDIRECTDRAW7 lpdd7, LPDDDEVICEIDENTIFIER2 lpdddi2, uint32_t dwFlags );
...
HRESULT __stdcall wCreateClipper(LPDIRECTDRAW7 lpdd7, uint32_t dwFlags, LPDIRECTDRAWCLIPPER* lplpDDClipper, IUnknown* pUnkOuter );
HRESULT __stdcall wSetDisplayMode(LPDIRECTDRAW7 lpdd7,uint32_t dwWidth,uint32_t dwHeight,uint32_t dwBPP,uint32_t dwRefreshRate,uint32_t dwFlags );
HRESULT __stdcall wGetAvailableVidMem(LPDIRECTDRAW7 lpdd7, LPDDSCAPS2 lpDDSCaps2, puint32_t lpdwTotal, puint32_t lpdwFree );
HRESULT __stdcall wGetFourCCCodes(LPDIRECTDRAW7 lpdd7, puint32_t lpNumCodes, puint32_t lpCodes );
...
HRESULT __stdcall wLock( LPDIRECTSOUNDBUFFER lpdsb, uint32_t dwWriteCursor, uint32_t dwWriteBytes, PVOID* lplpvAudioPtr1, puint32_t lpdwAudioBytes1, PVOID* lplpvAudioPtr2, puint32_t lpdwAudioBytes2, uint32_t dwFlags );
...
HRESULT __stdcall wGetCurrentPosition( LPDIRECTSOUNDBUFFER lpdsb, puint32_t lpdwCurrentPlayCursor, puint32_t lpdwCurrentWriteCursor );
...
HRESULT __stdcall wPlay( LPDIRECTSOUNDBUFFER lpdsb, uint32_t dwReserved1, uint32_t dwReserved2, uint32_t dwFlags );
...
HRESULT __stdcall wQuerySupport( LPKSPROPERTYSET lpPS, REFGUID rGUID, uint32_t uLong, puint32_t support );
...
HRESULT __stdcall wGetFormat( LPDIRECTSOUNDBUFFER lpdsb, LPWAVEFORMATEX lpwf, uint32_t sizeIn, puint32_t sizeOut );
...
HRESULT __stdcall wInitialize( PIAMMULTIMEDIASTREAM iammms, STREAM_TYPE StreamType, uint32_t dwFlags, PIGRAPHBUILDER pFilterGraph );
HRESULT __stdcall wAddMediaStream( PIAMMULTIMEDIASTREAM iammms, IUnknown* pStreamObject, const MSPID *pPurposeID, uint32_t dwFlags, PIMEDIASTREAM* ppNewStream );
HRESULT __stdcall wOpenFile( PIAMMULTIMEDIASTREAM iammms, LPCWSTR pszFileName, uint32_t dwFlags );

HRESULT __stdcall wCreateSample( PIDIRECTDRAWMEDIASTREAM iddms,LPDIRECTDRAWSURFACE pSurface, const RECT *pRect, uint32_t dwFlags, IDirectDrawStreamSample** ppSample );
...
HRESULT __stdcall wGetFormat( PIDIRECTDRAWMEDIASTREAM iddss, DDSURFACEDESC* ddsd_current, DDSURFACEDESC* ddsd_desired, puint32_t flags );
...
HRESULT __stdcall wGetInformation( PIMULTIMEDIASTREAM imms, puint32_t  flags, STREAM_TYPE *theType );
#endif

//
// Direct Input
//
HRESULT __stdcall wDirectInputCreateEx( HINSTANCE hinst, uint32_t dwVersion, REFIID riidltf, PVOID* ppvOut, LPUNKNOWN punkOuter );
...
HRESULT __stdcall wSetCooperativeLevel( LPDIRECTINPUTDEVICE7 dev, HWND hwnd, uint32_t dwFlags );
...
HRESULT __stdcall wEnumDevices( LPDIRECTINPUT7 di, uint32_t dwDevType, LPDIENUMDEVICESCALLBACK lpCallback, PVOID pvRef, uint32_t dwFlags );
...
HRESULT __stdcall wGetDeviceData( LPDIRECTINPUTDEVICE7 dev, uint32_t cbObjectData, LPDIDEVICEOBJECTDATA rgdod, puint32_t pdwInOut, uint32_t dwFlags );
...
HRESULT __stdcall wCancelPriority( IDirectPlay4A* dplay4, uint32_t dwMinPriority, uint32_t dwMaxPriority, uint32_t dwFlags );
HRESULT __stdcall wClose( IDirectPlay4A* dplay4 );
HRESULT __stdcall wCreateGroup( IDirectPlay4A* dplay4, LPDPID lpidGroup, LPDPNAME lpGroupName, PVOID lpData, uint32_t dwDataSize, uint32_t dwFlags );
HRESULT __stdcall wCreateGroupInGroup( IDirectPlay4A* dplay4, DPID idParentGroup, LPDPID lpidGroup, LPDPNAME lpGroupName, PVOID lpData, uint32_t dwDataSize, uint32_t dwFlags );
HRESULT __stdcall wCreatePlayer( IDirectPlay4A* dplay4, LPDPID lpidPlayer, LPDPNAME lpPlayerName, HANDLE hEvent, PVOID lpData, uint32_t dwDataSize, uint32_t dwFlags );
...
HRESULT __stdcall wEnumConnections( IDirectPlay4A* dplay4, LPCGUID lpguidApplication, LPDPENUMCONNECTIONSCALLBACK lpEnumCallback, PVOID lpContext, uint32_t dwFlags );
HRESULT __stdcall wEnumGroupPlayers( IDirectPlay4A* dplay4, DPID idGroup, LPGUID lpguidInstance, LPDPENUMPLAYERSCALLBACK2 lpEnumPlayersCallback2, PVOID lpContext, uint32_t dwFlags );
HRESULT __stdcall wEnumGroups( IDirectPlay4A* dplay4, LPGUID lpguidInstance, LPDPENUMPLAYERSCALLBACK2 lpEnumPlayersCallback2, PVOID lpContext, uint32_t dwFlags );
HRESULT __stdcall wEnumGroupsInGroup( IDirectPlay4A* dplay4, DPID idGroup, LPGUID lpguidInstance, LPDPENUMPLAYERSCALLBACK2 lpEnumCallback, PVOID lpContext, uint32_t dwFlags );
HRESULT __stdcall wEnumPlayers( IDirectPlay4A* dplay4, LPGUID lpguidInstance, LPDPENUMPLAYERSCALLBACK2 lpEnumPlayersCallback2, PVOID lpContext, uint32_t dwFlags );
HRESULT __stdcall wEnumSessions( IDirectPlay4A* dplay4, LPDPSESSIONDESC2 lpsd, uint32_t dwTimeout, LPDPENUMSESSIONSCALLBACK2 lpEnumSessionsCallback2, PVOID lpContext, uint32_t dwFlags );
HRESULT __stdcall wGetCaps( IDirectPlay4A* dplay4, LPDPCAPS lpDPCaps, uint32_t dwFlags );
HRESULT __stdcall wGetGroupConnectionSettings( IDirectPlay4A* dplay4, uint32_t dwFlags, DPID idGroup, PVOID lpData, puint32_t lpdwDataSize );
HRESULT __stdcall wGetGroupData( IDirectPlay4A* dplay4, DPID idGroup, PVOID lpData, puint32_t lpdwDataSize, uint32_t dwFlags );
HRESULT __stdcall wGetGroupFlags( IDirectPlay4A* dplay4, DPID idGroup, puint32_t lpdwFlags );
HRESULT __stdcall wGetGroupName( IDirectPlay4A* dplay4, DPID idGroup, PVOID lpData, puint32_t lpdwDataSize );
...
HRESULT __stdcall wGetMessageCount( IDirectPlay4A* dplay4, DPID idPlayer, puint32_t lpdwCount );
HRESULT __stdcall wGetMessageQueue( IDirectPlay4A* dplay4, DPID idFrom, DPID idTo, uint32_t dwFlags, puint32_t lpdwNumMsgs, puint32_t lpdwNumBytes );
HRESULT __stdcall wGetPlayerAccount( IDirectPlay4A* dplay4, DPID idPlayer, uint32_t dwFlags, PVOID lpData, puint32_t lpdwDataSize );
HRESULT __stdcall wGetPlayerAddress( IDirectPlay4A* dplay4, DPID idPlayer, PVOID lpData, puint32_t lpdwDataSize );
HRESULT __stdcall wGetPlayerCaps( IDirectPlay4A* dplay4, DPID idPlayer, LPDPCAPS lpPlayerCaps, uint32_t dwFlags );
HRESULT __stdcall wGetPlayerData( IDirectPlay4A* dplay4, DPID idPlayer, PVOID lpData, puint32_t lpdwDataSize, uint32_t dwFlags );
HRESULT __stdcall wGetPlayerFlags( IDirectPlay4A* dplay4, DPID idPlayer, puint32_t lpdwFlags );
HRESULT __stdcall wGetPlayerName( IDirectPlay4A* dplay4, DPID idPlayer, PVOID lpData, puint32_t lpdwDataSize );
HRESULT __stdcall wGetSessionDesc( IDirectPlay4A* dplay4, PVOID lpData, puint32_t lpdwDataSize );
HRESULT __stdcall wInitialize( IDirectPlay4A* dplay4, LPGUID lpGUID );
HRESULT __stdcall wInitializeConnection( IDirectPlay4A* dplay4, PVOID lpConnection, uint32_t dwFlags );
HRESULT __stdcall wOpen( IDirectPlay4A* dplay4, LPDPSESSIONDESC2 lpsd, uint32_t dwFlags );
HRESULT __stdcall wReceive( IDirectPlay4A* dplay4, LPDPID lpidFrom, LPDPID lpidTo, uint32_t dwFlags, PVOID lpData, puint32_t lpdwDataSize );
HRESULT __stdcall wSecureOpen( IDirectPlay4A* dplay4, LPCDPSESSIONDESC2 lpsd, uint32_t dwFlags, LPCDPSECURITYDESC lpSecurity, LPCDPCREDENTIALS lpCredentials );
HRESULT __stdcall wSendChatMessage( IDirectPlay4A* dplay4, DPID idFrom, DPID idTo, uint32_t dwFlags, LPDPCHAT lpChatMessage );
HRESULT __stdcall wSend( IDirectPlay4A* dplay4, DPID idFrom, DPID idTo, uint32_t dwFlags, PVOID lpData, uint32_t dwDataSize );
HRESULT __stdcall wSendEx( IDirectPlay4A* dplay4, DPID idFrom, DPID idTo, uint32_t dwFlags, PVOID lpData, uint32_t dwDataSize, uint32_t dwPriority, uint32_t dwTimeout, PVOID lpContext, puint32_t lpdwMsgID );
HRESULT __stdcall wSetGroupConnectionSettings( IDirectPlay4A* dplay4, uint32_t dwFlags, DPID idGroup, LPDPLCONNECTION lpConnection );
HRESULT __stdcall wSetGroupData( IDirectPlay4A* dplay4, DPID idGroup, PVOID lpData, uint32_t dwDataSize, uint32_t dwFlags );
HRESULT __stdcall wSetGroupName( IDirectPlay4A* dplay4, DPID idGroup, LPDPNAME lpGroupName, uint32_t dwFlags );
HRESULT __stdcall wSetGroupOwner( IDirectPlay4A* dplay4, DPID idGroup, DPID idOwner );
HRESULT __stdcall wSetPlayerData( IDirectPlay4A* dplay4, DPID idPlayer, PVOID lpData, uint32_t dwDataSize, uint32_t dwFlags );
HRESULT __stdcall wSetPlayerName( IDirectPlay4A* dplay4, DPID idPlayer, LPDPNAME lpPlayerName, uint32_t dwFlags );
HRESULT __stdcall wSetSessionDesc( IDirectPlay4A* dplay4, LPDPSESSIONDESC2 lpSessDesc, uint32_t dwFlags );
HRESULT __stdcall wStartSession( IDirectPlay4A* dplay4, uint32_t dwFlags, DPID idGroup );

// DirectPlay Lobby functions

HRESULT __stdcall wCreateAddress( IDirectPlayLobby3A* dplobby3, REFGUID guidSP, REFGUID guidDataType, LPCVOID lpData, uint32_t dwDataSize, PVOID lpAddress, puint32_t lpdwAddressSize );
HRESULT __stdcall wCreateCompoundAddress( IDirectPlayLobby3A* dplobby3, LPDPCOMPOUNDADDRESSELEMENT lpElements, uint32_t dwElementCount, PVOID lpAddress, puint32_t lpdwAddressSize );
HRESULT __stdcall wEnumAddress( IDirectPlayLobby3A* dplobby3, LPDPENUMADDRESSCALLBACK lpEnumAddressCallback, LPCVOID lpAddress, uint32_t dwAddressSize, PVOID lpContext );
HRESULT __stdcall wGetConnectionSettings( IDirectPlayLobby3A* dplobby3, uint32_t dwAppID, PVOID lpData, puint32_t lpdwDataSize );
HRESULT __stdcall wReceiveLobbyMessage( IDirectPlayLobby3A* dplobby3, uint32_t dwFlags, uint32_t dwAppID, puint32_t lpdwMessageFlags, PVOID lpData, puint32_t lpdwDataSize );
HRESULT __stdcall wRegisterApplication( IDirectPlayLobby3A* dplobby3, uint32_t dwFlags, LPDPAPPLICATIONDESC lpAppDesc );
HRESULT __stdcall wRunApplication( IDirectPlayLobby3A* dplobby3, uint32_t dwFlags, puint32_t lpdwAppID, LPDPLCONNECTION lpConn, HANDLE hReceiveEvent );
HRESULT __stdcall wSendLobbyMessage( IDirectPlayLobby3A* dplobby3, uint32_t dwFlags, uint32_t dwAppID, PVOID lpData, uint32_t dwDataSize );
HRESULT __stdcall wSetConnectionSettings( IDirectPlayLobby3A* dplobby3, uint32_t dwFlags, uint32_t dwAppID, LPDPLCONNECTION lpConn );
HRESULT __stdcall wSetLobbyMessageEvent( IDirectPlayLobby3A* dplobby3, uint32_t dwFlags, uint32_t dwAppID, HANDLE hReceiveEvent );
HRESULT __stdcall wUnregisterApplication( IDirectPlayLobby3A* dplobby3, uint32_t dwFlags, REFGUID guidApplication );
HRESULT __stdcall wWaitForConnectionSettings( IDirectPlayLobby3A* dplobby3, uint32_t dwFlags );
HRESULT __stdcall wConnectEx( IDirectPlayLobby3A* dplobby3, uint32_t dwFlags, REFIID riid, PVOID *lplpDP, IUnknown* pUnk );
#endif
