...
void
DualTextureEffect::Impl::Apply(_In_ ID3D12GraphicsCommandList* commandList)
{
...
// IEffect methods
void
DualTextureEffect::Apply(_In_ ID3D12GraphicsCommandList* commandList)
{
...
// Camera settings
void XM_CALLCONV
DualTextureEffect::SetWorld(FXMMATRIX value)
{
...
void XM_CALLCONV
DualTextureEffect::SetView(FXMMATRIX value)
{
...
void XM_CALLCONV
DualTextureEffect::SetProjection(FXMMATRIX value)
{
...
void XM_CALLCONV
DualTextureEffect::SetMatrices(FXMMATRIX world, CXMMATRIX view, CXMMATRIX projection)
{
...
void
DualTextureEffect::SetAlpha(float value)
{
...
// Fog settings.
void
DualTextureEffect::SetFogStart(float value)
{
...
void
DualTextureEffect::SetFogEnd(float value)
{
	pImpl->fog.end = value;
...
// Texture settings.
void
DualTextureEffect::SetTexture(D3D12_GPU_DESCRIPTOR_HANDLE srvDescriptor, D3D12_GPU_DESCRIPTOR_HANDLE samplerDescriptor)
{
...
void
DualTextureEffect::SetTexture2(D3D12_GPU_DESCRIPTOR_HANDLE srvDescriptor, D3D12_GPU_DESCRIPTOR_HANDLE samplerDescriptor)
{
