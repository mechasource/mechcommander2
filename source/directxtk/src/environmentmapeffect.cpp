	...
	environmentMapSampler{}
{
	...
	{
		DebugTrace("ERROR: EnvironmentMapEffect does not implement EffectFlags::Vertexcolour\n");
	...
	lights.InitializeConstants(unwantedOutput[0], constants.lightDirection, constants.lightDiffusecolour, unwantedOutput);
	...
	_ASSERT(sp >= 0 && sp < EnvironmentMapEffectTraits::ShaderPermutationCount);
	...
	_ASSERT(vi >= 0 && vi < EnvironmentMapEffectTraits::VertexShaderCount);
	...
	_ASSERT(pi >= 0 && pi < EnvironmentMapEffectTraits::PixelShaderCount);
...
int
EnvironmentMapEffect::Impl::GetPipelineStatePermutation(
...
void
EnvironmentMapEffect::Impl::Apply(_In_ ID3D12GraphicsCommandList* commandList)
{
...
// Camera settings.
void XM_CALLCONV
EnvironmentMapEffect::SetWorld(FXMMATRIX value)
{
...
void XM_CALLCONV
EnvironmentMapEffect::SetView(FXMMATRIX value)
{
...
void XM_CALLCONV
EnvironmentMapEffect::SetProjection(FXMMATRIX value)
{
...
void XM_CALLCONV
EnvironmentMapEffect::SetMatrices(FXMMATRIX world, CXMMATRIX view, CXMMATRIX projection)
{
...
// Material settings.
void XM_CALLCONV
EnvironmentMapEffect::SetDiffusecolour(FXMVECTOR value)
{
...
void XM_CALLCONV
EnvironmentMapEffect::SetEmissivecolour(FXMVECTOR value)
{
...
void
EnvironmentMapEffect::SetAlpha(float value)
{
...
void XM_CALLCONV
EnvironmentMapEffect::SetcolourAndAlpha(FXMVECTOR value)
{
	pImpl->lights.diffusecolour = value;
...
// Light settings.
void XM_CALLCONV
EnvironmentMapEffect::SetAmbientLightcolour(FXMVECTOR value)
{
...
void
EnvironmentMapEffect::SetLightEnabled(int whichLight, bool value)
{
	XMVECTOR unwantedOutput[MaxDirectionalLights] = {};

	pImpl->dirtyFlags |= pImpl->lights.SetLightEnabled(whichLight, value, pImpl->constants.lightDiffusecolour, unwantedOutput);
}

void XM_CALLCONV
EnvironmentMapEffect::SetLightDirection(int whichLight, FXMVECTOR value)
{
...
void XM_CALLCONV
EnvironmentMapEffect::SetLightDiffusecolour(int whichLight, FXMVECTOR value)
{
	pImpl->dirtyFlags |= pImpl->lights.SetLightDiffusecolour(whichLight, value, pImpl->constants.lightDiffusecolour);
}

void XM_CALLCONV
EnvironmentMapEffect::SetLightSpecularcolour(int, FXMVECTOR)
{
...
// Fog settings.
void
EnvironmentMapEffect::SetFogStart(float value)
{
...
void
EnvironmentMapEffect::SetFogEnd(float value)
{
	pImpl->fog.end = value;
...
void XM_CALLCONV
EnvironmentMapEffect::SetFogcolour(FXMVECTOR value)
{
...
// Texture settings.
void
EnvironmentMapEffect::SetTexture(D3D12_GPU_DESCRIPTOR_HANDLE texture, D3D12_GPU_DESCRIPTOR_HANDLE sampler)
{
...
void
EnvironmentMapEffect::SetEnvironmentMap(D3D12_GPU_DESCRIPTOR_HANDLE texture, D3D12_GPU_DESCRIPTOR_HANDLE sampler)
{
...
// Additional settings.
void
EnvironmentMapEffect::SetEnvironmentMapAmount(float value)
{
...
void XM_CALLCONV
EnvironmentMapEffect::SetEnvironmentMapSpecular(FXMVECTOR value)
{
...
void
EnvironmentMapEffect::SetFresnelFactor(float value)
{
