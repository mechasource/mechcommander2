...
float
ApplyLinearDeadZone(float value, float maxValue, float deadZoneSize)
{
...
void
ApplyStickDeadZone(float x, float y, GamePad::DeadZone deadZoneMode, float maxValue, float deadZoneSize,
...
{
public:
	class GamepadAddedListener : public Microsoft::WRL::RuntimeClass<Microsoft::WRL::RuntimeClassFlags<Microsoft::WRL::ClassicCom>, ABI::Windows::Foundation::IEventHandler<ABI::Windows::Xbox::Input::GamepadAddedEventArgs*>, Microsoft::WRL::FtmBase>
	{
	public:
	...
	class GamepadRemovedListener : public Microsoft::WRL::RuntimeClass<Microsoft::WRL::RuntimeClassFlags<Microsoft::WRL::ClassicCom>, ABI::Windows::Foundation::IEventHandler<ABI::Windows::Xbox::Input::GamepadRemovedEventArgs*>, Microsoft::WRL::FtmBase>
	{
	public:
	...
	class UserPairingListener : public Microsoft::WRL::RuntimeClass<Microsoft::WRL::RuntimeClassFlags<Microsoft::WRL::ClassicCom>, ABI::Windows::Foundation::IEventHandler<ABI::Windows::Xbox::Input::ControllerPairingChangedEventArgs*>, Microsoft::WRL::FtmBase>
	{
	public:
...
public:
	...
	, mLeftMotor{}, mRightMotor{}, mSuspended(false)
#endif
	{
...
GamePad::State
GamePad::GetState(int player, DeadZone deadZoneMode)
{
	State state;
...
GamePad::GetCapabilities(int player)
{
	Capabilities caps;
...
bool
GamePad::SetVibration(int player, float leftMotor, float rightMotor, float leftTrigger, float rightTrigger)
{
...
void
GamePad::RegisterEvents(HANDLE ctrlChanged, HANDLE userChanged)
{
...
void
GamePad::ButtonStateTracker::Update(const GamePad::State& state)
{
...
void
GamePad::ButtonStateTracker::Reset() noexcept
{
