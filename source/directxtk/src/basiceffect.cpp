...
void
BasicEffect::Impl::Apply(_In_ ID3D12GraphicsCommandList* commandList)
{
...
// IEffect methods
void
BasicEffect::Apply(_In_ ID3D12GraphicsCommandList* commandList)
{
...
// Camera settings
void XM_CALLCONV
BasicEffect::SetWorld(FXMMATRIX value)
{
...
void XM_CALLCONV
BasicEffect::SetView(FXMMATRIX value)
{
...
void XM_CALLCONV
BasicEffect::SetProjection(FXMMATRIX value)
{
...
void XM_CALLCONV
BasicEffect::SetMatrices(FXMMATRIX world, CXMMATRIX view, CXMMATRIX projection)
{
...
void
BasicEffect::SetAlpha(float value)
{
...
void XM_CALLCONV
BasicEffect::SetLightDirection(int whichLight, FXMVECTOR value)
{
...
// Fog settings.
void
BasicEffect::SetFogStart(float value)
{
...
void
BasicEffect::SetFogEnd(float value)
{
	pImpl->fog.end = value;
...
// Texture settings.
void
BasicEffect::SetTexture(D3D12_GPU_DESCRIPTOR_HANDLE srvDescriptor, D3D12_GPU_DESCRIPTOR_HANDLE samplerDescriptor)
{
