...
void XM_CALLCONV
IEffectMatrices::SetMatrices(FXMMATRIX world, CXMMATRIX view, CXMMATRIX projection)
{
	SetWorld(world);
	SetView(view);
...
EffectMatrices::SetConstants(int& dirtyFlags, XMMATRIX& worldViewProjConstant)
{
...
EffectFog::SetConstants(int& dirtyFlags, FXMMATRIX worldView, XMVECTOR& fogVectorConstant)
{
	if (enabled)
	{
...
void
EffectLights::ValidateLightIndex(int whichLight)
{
...
void
EffectLights::EnableDefaultLighting(_In_ IEffectLights* effect)
{
