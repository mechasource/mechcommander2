...
public:
	...
	//
protected:
	MLR_I_L_PMesh(ClassData* class_data, std::iostream stream, uint32_t version);
	~MLR_I_L_PMesh(void);

public:
	MLR_I_L_PMesh(ClassData* class_data = MLR_I_L_PMesh::DefaultData);

	static MLR_I_L_PMesh* Make(std::iostream stream, uint32_t version);
...
//	MLR_I_L_PMesh*
//		CreateIndexedCube(float, Stuff::RGBAcolour*, Stuff::Vector3D*,
// MLRState*);
MLRShape*
CreateIndexedIcosahedron_colour_Lit(IcoInfo&, MLRState*);
} // namespace MidLevelRenderer
#endif
