...
void MLR_I_C_TMesh::InitializeClass()
{
	...
	DefaultData = new ClassData(MLR_I_C_TMeshClassID, "MidLevelRenderer::MLR_I_C_TMesh",
		MLR_I_TMesh::DefaultData, (MLRPrimitiveBase::Factory)&Make);
	Register_Object(DefaultData);
#if defined(TRACE_ENABLED) && defined(MLR_TRACE)
	MLR_I_C_TMesh_Clip = new BitTrace("MLR_I_C_TMesh_Clip");
	Register_Object(MLR_I_C_TMesh_Clip);
#endif
}
...
void MLR_I_C_TMesh::TerminateClass()
{
	...
	DefaultData = nullptr;
#if defined(TRACE_ENABLED) && defined(MLR_TRACE)
	Unregister_Object(MLR_I_C_TMesh_Clip);
	delete MLR_I_C_TMesh_Clip;
#endif
}
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//
MLR_I_C_TMesh::MLR_I_C_TMesh(ClassData* class_data) : MLR_I_TMesh(class_data), colors(0)
{
	// Check_Pointer(this);
	// _ASSERT(gos_GetCurrentHeap() == Heap);
	actualColors = &colors;
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//
MLR_I_C_TMesh* MLR_I_C_TMesh::Make(std::iostream stream, uint32_t version)
{
	Check_Object(stream);
#ifdef _GAMEOS_HPP_
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//
void MLR_I_C_TMesh::TestInstance(void) const { _ASSERT(IsDerivedFrom(DefaultData)); }
...
#define CLASSNAME MLR_I_C_TMesh

#if defined(TRACE_ENABLED) && defined(MLR_TRACE)
#define SET_MLR_TMESH_CLIP() MLR_I_C_TMesh_Clip->Set()
#define CLEAR_MLR_TMESH_CLIP() MLR_I_C_TMesh_Clip->Clear()
#else
...
//	void MLR_I_C_TMesh::TransformNoClip(Matrix4D*, GOSVertexPool*);
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//
MLR_I_C_TMesh* MidLevelRenderer::CreateIndexedTriCube_Color_NoLit(float half, MLRState* state)
{
	(void)half;
	(void)state;
