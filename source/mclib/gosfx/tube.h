...
class Tube__Specification : public Effect__Specification
{
	...
	//
protected:
	Tube__Specification(std::iostream stream, uint32_t gfx_version);

public:
	Tube__Specification(void);

	static Tube__Specification* Make(std::iostream stream, uint32_t gfx_version);
...
public:
	...
	SeededCurveOf<ComplexCurve, SplineCurve, Curve::e_ComplexSplineType> m_pDisplacement, m_pScale;
	SeededCurveOf<ComplexCurve, LinearCurve, Curve::e_ComplexLinearType> m_pRed, m_pGreen, m_pBlue,
		m_pAlpha;
	SeededCurveOf<ComplexCurve, SplineCurve, Curve::e_ComplexSplineType> m_pUOffset, m_pVOffset;
	SeededCurveOf<SplineCurve, SplineCurve, Curve::e_SplineSplineType> m_pUSize, m_pVSize;
...
public:
	...
	std::vector<Stuff::Point3D> m_vertices;
	std::vector<Stuff::Vector2DOf<float>> m_uvs;
...
protected:
	...
	bool AnimateProfile(uint32_t index, uint32_t profile,
		const Stuff::LinearMatrix4D& world_to_new_local, Stuff::Time till, Stuff::Sphere* sphere);
