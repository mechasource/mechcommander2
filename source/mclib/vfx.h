...
#define PIXELS_IN_PANEP(pane) (((pane)->x1 - (pane)->x0 + 1) * ((pane)->y1 - (pane)0 > y0 + 1))
	...
	*/
	...
	extern int32_t VFX_CALL VFX_pane_list_add_area(
		PPANE_LIST list, PWINDOW window, int32_t x0, int32_t y0, int32_t x1, int32_t y1);
	...
	extern int32_t VFX_CALL VFX_pane_copy(
		PPANE source, int32_t sx, int32_t sy, PPANE target, int32_t tx, int32_t ty, int32_t fill);
	extern int32_t VFX_CALL VFX_pane_scroll(
		PPANE pane, int32_t dx, int32_t dy, int32_t mode, int32_t parm);
	extern void VFX_CALL VFX_ellipse_draw(
		PPANE pane, int32_t xc, int32_t yc, int32_t width, int32_t height, int32_t color);
	extern void VFX_CALL VFX_ellipse_fill(
		PPANE pane, int32_t xc, int32_t yc, int32_t width, int32_t height, int32_t color);
	extern void VFX_CALL VFX_point_transform(PVFX_POINT in, PVFX_POINT out, PVFX_POINT origin,
		int32_t rot, int32_t x_scale, int32_t y_scale);
	...
	extern void VFX_CALL VFX_shape_transform(PPANE pane, PVOID shape_table, int32_t shape_number,
		int32_t hotX, int32_t hotY, PVOID buffer, int32_t rot, int32_t x_scale, int32_t y_scale,
		int32_t flags);
