...
// Material settings.
void XM_CALLCONV
SkinnedEffect::SetDiffuseColor(FXMVECTOR value)
{
...
void XM_CALLCONV
SkinnedEffect::SetEmissiveColor(FXMVECTOR value)
{
...
void XM_CALLCONV
SkinnedEffect::SetSpecularColor(FXMVECTOR value)
{
...
void XM_CALLCONV
SkinnedEffect::SetColorAndAlpha(FXMVECTOR value)
{
	pImpl->lights.diffuseColor = value;
...
// Light settings.
void XM_CALLCONV
SkinnedEffect::SetAmbientLightColor(FXMVECTOR value)
{
...
void XM_CALLCONV
SkinnedEffect::SetLightDiffuseColor(int whichLight, FXMVECTOR value)
{
	pImpl->dirtyFlags |= pImpl->lights.SetLightDiffuseColor(whichLight, value, pImpl->constants.lightDiffuseColor);
}

void XM_CALLCONV
SkinnedEffect::SetLightSpecularColor(int whichLight, FXMVECTOR value)
{
...
void XM_CALLCONV
SkinnedEffect::SetFogColor(FXMVECTOR value)
{
