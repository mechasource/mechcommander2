...
class LogisticsMech
{
	public:
		...
		const EString&		getSmallIconFileName(void) const { return pVariant->chassis->iconFileNames[0]; }
		const EString&		getMediumIconFileName(void) const { return pVariant->chassis->iconFileNames[1]; }
		const EString&		getLargeIconFileName(void) const { return pVariant->chassis->iconFileNames[2]; }
