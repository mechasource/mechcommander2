...
#define LEFT_Z                  (-RIGHT_Z)
	...
	public:
		...
		// Constructors
		//
		Vector3D(void) { x = 0.f; y = 0.f; z = 0.f; }
...
namespace MemoryStreamIO{
	...
	inline Stuff::MemoryStream& Read(Stuff::MemoryStream* stream, Stuff::Vector3D *output)
	{
		return stream->ReadBytes(output, sizeof(*output));
	}
	inline Stuff::MemoryStream& Write(Stuff::MemoryStream* stream, const Stuff::Vector3D *input)
	{
