	...
	D3D12_SUBRESOURCE_DATA& subresource) noexcept
{
	...
	uint32_t mipCount = (loadFlags & (WIC_LOADER_MIP_AUTOGEN | WIC_LOADER_MIP_RESERVE))
		? LoaderHelpers::CountMips(twidth, theight)
		: 1u;
...
_Use_decl_annotations_
	HRESULT
	directxtk::LoadWICTextureFromMemory(
...
_Use_decl_annotations_
	HRESULT
	directxtk::CreateWICTextureFromMemory(
		ID3D12Device* d3dDevice,
...
_Use_decl_annotations_
	HRESULT
	directxtk::LoadWICTextureFromMemoryEx(
		ID3D12Device* d3dDevice,
		const uint8_t* wicData,
		size_t wicDataSize,
		size_t maxsize,
...
_Use_decl_annotations_
	HRESULT
	directxtk::CreateWICTextureFromMemoryEx(
		ID3D12Device* d3dDevice,
		ResourceUploadBatch& resourceUpload,
		const uint8_t* wicData,
		size_t wicDataSize,
...
_Use_decl_annotations_
	HRESULT
	directxtk::LoadWICTextureFromFile(
		ID3D12Device* d3dDevice,
...
_Use_decl_annotations_
	HRESULT
	directxtk::LoadWICTextureFromFileEx(
		ID3D12Device* d3dDevice,
		std::wstring_view filename,
		size_t maxsize,
		D3D12_RESOURCE_FLAGS resFlags,
...
_Use_decl_annotations_
	HRESULT
	directxtk::CreateWICTextureFromFileEx(
		ID3D12Device* d3dDevice,
		ResourceUploadBatch& resourceUpload,
		std::wstring_view filename,
		size_t maxsize,
