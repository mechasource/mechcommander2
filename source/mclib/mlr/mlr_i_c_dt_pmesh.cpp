...
void MLR_I_C_DT_PMesh::InitializeClass()
{
	...
	DefaultData = new ClassData(MLR_I_C_DT_PMeshClassID,
		"MidLevelRenderer::MLR_I_C_DT_PMesh", MLR_I_DT_PMesh::DefaultData,
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//
MLR_I_C_DT_PMesh* MLR_I_C_DT_PMesh::Make(
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//
void MLR_I_C_DT_PMesh::Save(Stuff::MemoryStream* stream)
{
	// Check_Object(this);
	Check_Object(stream);
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//
void MLR_I_C_DT_PMesh::SetColorData(
#if COLOR_AS_DWORD
	pcuint32_t data,
#else
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//
void MLR_I_C_DT_PMesh::GetColorData(
#if COLOR_AS_DWORD
	puint32_t* data,
#else
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//
MLR_I_C_DT_PMesh* MidLevelRenderer::CreateIndexedCube_Color_NoLit_2Tex(
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//
MLRShape* MidLevelRenderer::CreateIndexedIcosahedron_Color_NoLit_2Tex(
