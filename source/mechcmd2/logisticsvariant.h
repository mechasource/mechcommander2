...
class LogisticsVariant
{
  ...
  public:
	...
	int32_t getComponentsWithLocation(int32_t& count, int32_t* IDArray,
		int32_t* xLocationArray, int32_t* yLocationArray);
	...
	LogisticsComponent* getCompAtLocation(
		int32_t i, int32_t j, int32_t& realI, int32_t& realJ);
	int32_t getComponentLocation(
		LogisticsComponent* pComp, int32_t& i, int32_t& j);
  ...
  protected:
	const LogisticsChassis::ComponentInfo* getComponentAtLocation(
