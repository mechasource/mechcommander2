...
bool Origin3D::TestClass()
{
	...
	UnitQuaternion r;
	r = q;
	const Origin3D a(p, r);
	Origin3D b;
	UnitQuaternion t;
	t = a.angularPosition;
	Test_Assumption(a.linearPosition == p && t.x == q.x && t.w == q.w);
	LinearMatrix4D m;
	m = a;
	b = m;
	t = b;
	Test_Assumption(a.linearPosition == b.linearPosition && t.y == q.y);
#if 0
