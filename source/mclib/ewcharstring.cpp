...
cint32_t EWCharString::INVALID_INDEX = -1;
cint32_t EWCharString::s_Alloc_Allign = 4;
cint32_t EWCharString::s_Force_Ansi =  0x10000;
cint32_t EWCharString::s_Force_Unicode = 0x20000;
...
/////////////////////////////////////////////////////////////////
const EWCharString& EWCharString::operator+=( PCSTR p_String )
{
	if ( p_String )
	{
		*this += A2W( p_String );
...
/////////////////////////////////////////////////////////////////
bool EWCharString::operator<( PCSTR p_String ) const
{
	return operator<(A2W( p_String ) );
}

/////////////////////////////////////////////////////////////////
bool operator<( PCSTR p_String, const EWCharString& String )
{
...
/////////////////////////////////////////////////////////////////
void EWCharString::Format( PCSTR p_Str, ... )
{
...
/////////////////////////////////////////////////////////////////
bool EWCharString::operator==( PCSTR p_String )
{
	return operator==( A2W( p_String ) );
}
