...
struct Rectangle
{
	...
	XM_CONSTEXPR Rectangle(long ix, long iy, long iw, long ih) :
		x(ix), y(iy), width(iw), height(ih) {}
	explicit Rectangle(const RECT& rct) :
	...
	operator Windows::Foundation::Rect()
	{
	...
	Rectangle& operator=(_In_ const RECT& rct)
	{
		x = rct.left;
		y = rct.top;
...
struct Vector2 : public XMFLOAT2
{
	Vector2() noexcept :
		XMFLOAT2(0.f, 0.f) {}
	XM_CONSTEXPR explicit Vector2(float ix) :
		XMFLOAT2(ix, ix) {}
	XM_CONSTEXPR Vector2(float ix, float iy) :
		XMFLOAT2(ix, iy) {}
	...
	explicit Vector2(const XMVECTORF32& F)
	{
		this->x = F.f[0];
		this->y = F.f[1];
	}
	...
	// Assignment operators
	Vector2& operator=(const XMVECTORF32& F)
	{
		x = F.f[0];
		y = F.f[1];
		return *this;
...
struct Vector3 : public XMFLOAT3
{
	...
	XM_CONSTEXPR explicit Vector3(float ix) :
		XMFLOAT3(ix, ix, ix) {}
	XM_CONSTEXPR Vector3(float ix, float iy, float iz) :
		XMFLOAT3(ix, iy, iz) {}
	...
	explicit Vector3(const XMVECTORF32& F)
	{
		this->x = F.f[0];
		this->y = F.f[1];
		this->z = F.f[2];
	...
	// Assignment operators
	Vector3& operator=(const XMVECTORF32& F)
	{
		x = F.f[0];
		y = F.f[1];
		z = F.f[2];
...
struct Vector4 : public XMFLOAT4
{
	...
	XM_CONSTEXPR explicit Vector4(float ix) :
		XMFLOAT4(ix, ix, ix, ix) {}
	XM_CONSTEXPR Vector4(float ix, float iy, float iz, float iw) :
	...
	explicit Vector4(const XMVECTORF32& F)
	{
		this->x = F.f[0];
		this->y = F.f[1];
		this->z = F.f[2];
	...
	// Assignment operators
	Vector4& operator=(const XMVECTORF32& F)
	{
		x = F.f[0];
		y = F.f[1];
		z = F.f[2];
...
struct Plane : public XMFLOAT4
{
	...
	XM_CONSTEXPR Plane(float ix, float iy, float iz, float iw) :
		XMFLOAT4(ix, iy, iz, iw) {}
	...
	explicit Plane(const XMVECTORF32& F)
	{
		this->x = F.f[0];
		this->y = F.f[1];
		this->z = F.f[2];
	...
	// Assignment operators
	Plane& operator=(const XMVECTORF32& F)
	{
		x = F.f[0];
		y = F.f[1];
		z = F.f[2];
...
struct Quaternion : public XMFLOAT4
{
	Quaternion() noexcept :
		XMFLOAT4(0, 0, 0, 1.f) {}
	XM_CONSTEXPR Quaternion(float ix, float iy, float iz, float iw) :
		XMFLOAT4(ix, iy, iz, iw) {}
	...
	explicit Quaternion(const XMVECTORF32& F)
	{
		this->x = F.f[0];
		this->y = F.f[1];
		this->z = F.f[2];
	...
	// Assignment operators
	Quaternion& operator=(const XMVECTORF32& F)
	{
		x = F.f[0];
		y = F.f[1];
		z = F.f[2];
