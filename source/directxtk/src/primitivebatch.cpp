...
void
PrimitiveBatchBase::Impl::Begin(_In_ ID3D12GraphicsCommandList* cmdList)
{
	if (mInBeginEndPair)
...
static bool
CanBatchPrimitives(D3D_PRIMITIVE_TOPOLOGY topology)
{
	switch (topology)
	{
...
PrimitiveBatchBase::Impl::Draw(D3D_PRIMITIVE_TOPOLOGY topology, bool isIndexed, uint16_t const* indices, size_t indexCount, size_t vertexCount, void** pMappedVertices)
{
...
void
PrimitiveBatchBase::Impl::FlushBatch()
{
...
void
PrimitiveBatchBase::Begin(_In_ ID3D12GraphicsCommandList* cmdList)
{
	pImpl->Begin(cmdList);
}

void
PrimitiveBatchBase::End()
{
	pImpl->End();
}

_Use_decl_annotations_ void
PrimitiveBatchBase::Draw(D3D12_PRIMITIVE_TOPOLOGY topology, bool isIndexed, uint16_t const* indices, size_t indexCount, size_t vertexCount, void** pMappedVertices)
{
