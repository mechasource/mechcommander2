...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//
static uint8_t __stdcall Check_4hz()
{
	return uint8_t((Environment.MaxTimeDelta == 0.25f) ? 1 : 0);
}
static uint8_t __stdcall Check_40hz()
{
	return uint8_t((Environment.MaxTimeDelta == 0.025f) ? 1 : 0);
}
static uint8_t __stdcall Check_400hz()
{
	return uint8_t((Environment.MaxTimeDelta == 0.0025f) ? 1 : 0);
}

static void __stdcall Activate_4hz()
{
	Environment.MaxTimeDelta = Environment.MinimumTimeDelta = 0.25f;
}
static void __stdcall Activate_40hz()
{
	Environment.MaxTimeDelta = Environment.MinimumTimeDelta = 0.025f;
}
static void __stdcall Activate_400hz()
{
	Environment.MaxTimeDelta = Environment.MinimumTimeDelta = 0.0025f;
}
