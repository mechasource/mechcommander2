...
MLR_I_L_PMesh::DefaultData = nullptr;
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//
MLR_I_L_PMesh* MLR_I_L_PMesh::Make(Stuff::MemoryStream* stream, uint32_t version)
{
	Check_Object(stream);
	#ifdef _GAMEOS_HPP_
...
//
void
MLR_I_L_PMesh::Save(Stuff::MemoryStream* stream)
{
	// Check_Object(this);
	Check_Object(stream);
