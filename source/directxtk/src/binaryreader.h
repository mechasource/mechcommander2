...
{
public:
	explicit BinaryReader(_In_ std::wstring_view filename) noexcept(false);
	...
	static HRESULT ReadEntireFile(_In_ std::wstring_view filename, _Inout_ std::unique_ptr<uint8_t[]>& data, _Out_ size_t* datasize);
