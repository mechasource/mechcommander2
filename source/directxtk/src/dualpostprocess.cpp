...
void
DualPostProcess::Impl::Process(_In_ ID3D12GraphicsCommandList* commandList)
{
...
void
DualPostProcess::Process(_In_ ID3D12GraphicsCommandList* commandList)
{
...
// Properties
void
DualPostProcess::SetSourceTexture(D3D12_GPU_DESCRIPTOR_HANDLE srvDescriptor)
{
	pImpl->texture = srvDescriptor;
}

void
DualPostProcess::SetSourceTexture2(D3D12_GPU_DESCRIPTOR_HANDLE srvDescriptor)
{
	pImpl->texture2 = srvDescriptor;
}

void
DualPostProcess::SetMergeParameters(float weight1, float weight2)
{
...
void
DualPostProcess::SetBloomCombineParameters(float bloom, float base, float bloomSaturation, float baseSaturation)
{
