...
//##########################################################################
	...
	public:
		...
		{
			if(b == true) systemFlags |= HasAGPAvailable;
			else systemFlags &= ~HasAGPAvailable;
		}

		static void
		SetMultitextureLightMap(bool b)
		{
			if(b == true) systemFlags |= CanMultitextureLightMap;
			else systemFlags &= ~CanMultitextureLightMap;
		}

		static void
		SetMultitextureSpecularMap(bool b)
		{
			if(b == true) systemFlags |= CanMultitextureSpecularMap;
			else systemFlags &= ~CanMultitextureSpecularMap;
		}

		static void
		SetHasMaxUVs(bool b)
		{
			if(b == true) systemFlags |= HasMaxUVs;
			else systemFlags &= ~HasMaxUVs;
		}
