...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//
void MLR_I_L_PMesh::TestInstance(void) const
{
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//
void MLR_I_L_PMesh::GetNormalData(Stuff::Vector3D** data, size_t* dataSize)
{
	// Check_Object(this);
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//
void MLR_I_L_PMesh::SetcolourData(
#if COLOR_AS_DWORD
	const uint32_t* data,
#else
...
//
MLRShape*
MidLevelRenderer::CreateIndexedIcosahedron_colour_Lit(IcoInfo& icoInfo, MLRState* state)
{
#ifdef _GAMEOS_HPP_
	gos_PushCurrentHeap(Heap);
#endif
