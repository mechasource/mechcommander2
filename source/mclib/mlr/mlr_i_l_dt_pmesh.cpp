...
//
MLR_I_L_DT_PMesh*
MLR_I_L_DT_PMesh::Make(std::iostream stream, uint32_t version)
{
	Check_Object(stream);
#ifdef _GAMEOS_HPP_
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//
void MLR_I_L_DT_PMesh::TestInstance(void) const
{
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//
void MLR_I_L_DT_PMesh::GetNormalData(Stuff::Vector3D** data, size_t* dataSize)
{
	// Check_Object(this);
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//
void MLR_I_L_DT_PMesh::SetcolourData(
#if COLOR_AS_DWORD
	const uint32_t* data,
#else
...
//
MLRShape*
MidLevelRenderer::CreateIndexedIcosahedron_colour_Lit_2Tex(
