...
//#pragma warning (disable:4786)							// this is necessary to avoid
//"truncated to 255 characters in debug info" message #include
//<stuff/auto_ptr.hpp> #include <stuff/noncopyable.hpp>

#if _CONSIDERED_OBSOLETE
namespace Stuff
{
template <class pointed_to, class container_type>
class Auto_Container : public Noncopyable
{
  public:
	virtual ~Auto_Container() { clear(void); }
	...
	const container_type& GetContainer(void) const { return (m_Container); }
