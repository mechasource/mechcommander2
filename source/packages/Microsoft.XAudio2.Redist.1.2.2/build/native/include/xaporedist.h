...
DECLARE_INTERFACE_(IXAPO, IUnknown)
{
	...
	//  COM error code
	////
	STDMETHOD(GetRegistrationProperties)
	(THIS_ _Outptr_ XAPO_REGISTRATION_PROPERTIES * *ppRegistrationProperties) PURE;
	...
	(THIS_ const WAVEFORMATEX* pOutputFormat, const WAVEFORMATEX* pRequestedInputFormat, _Outptr_opt_ WAVEFORMATEX** ppSupportedInputFormat) PURE;
	...
	(THIS_ const WAVEFORMATEX* pInputFormat, const WAVEFORMATEX* pRequestedOutputFormat, _Outptr_opt_ WAVEFORMATEX** ppSupportedOutputFormat) PURE;
	...
	(THIS_ _In_reads_bytes_opt_(DataByteSize) const void* pData, UINT32 DataByteSize) PURE;
	...
	(THIS_ UINT32 InputLockedParameterCount, _In_reads_opt_(InputLockedParameterCount) const XAPO_LOCKFORPROCESS_PARAMETERS* pInputLockedParameters, UINT32 OutputLockedParameterCount, _In_reads_opt_(OutputLockedParameterCount) const XAPO_LOCKFORPROCESS_PARAMETERS* pOutputLockedParameters) PURE;
	...
	////
	STDMETHOD_(UINT32, CalcInputFrames)
	(THIS_ UINT32 OutputFrameCount) PURE;
	...
	////
	STDMETHOD_(UINT32, CalcOutputFrames)
	(THIS_ UINT32 InputFrameCount) PURE;
};
...
DECLARE_INTERFACE_(IXAPOParameters, IUnknown)
{
	...
	(THIS_ _In_reads_bytes_(ParameterByteSize) const void* pParameters, UINT32 ParameterByteSize) PURE;
	...
	(THIS_ _Out_writes_bytes_(ParameterByteSize) void* pParameters, UINT32 ParameterByteSize) PURE;
};
