...
public:
	...
	inline const std::wstring_view& getFileName() { return pVariant->chassis->fileName; }
	...
	const std::wstring_view& getName(void) const { return pVariant->variantName; }
	...
	const std::wstring_view& getMechClass(void) const { return pVariant->getMechClass(void); }
	...
	const std::wstring_view& getSmallIconFileName(void) const
	{
		return pVariant->chassis->iconFileNames[0];
	}
	const std::wstring_view& getMediumIconFileName(void) const
	{
		return pVariant->chassis->iconFileNames[1];
	}
	const std::wstring_view& getLargeIconFileName(void) const
	{
