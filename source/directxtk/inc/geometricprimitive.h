...
namespace directxtk
{
    ...
    public:
        ...
        static std::unique_ptr<GeometricPrimitive> __cdecl CreateBox(const DirectX::XMFLOAT3& size, bool rhcoords = true, bool invertn = false, _In_opt_ ID3D12Device* device = nullptr);
        ...
        static void __cdecl CreateBox(std::vector<VertexType>& vertices, std::vector<uint16_t>& indices, const DirectX::XMFLOAT3& size, bool rhcoords = true, bool invertn = false);
