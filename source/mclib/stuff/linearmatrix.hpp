...
class LinearMatrix4D : public AffineMatrix4D
{
  public:
	...
	LinearMatrix4D& operator=(const YawPitchRoll& angles)
	{
		AffineMatrix4D::operator=(angles);
		// Check_Object(this);
		return *this;
	...
	LinearMatrix4D& BuildRotation(const EulerAngles& angles)
	{
		AffineMatrix4D::BuildRotation(angles);
		return *this;
	}
	LinearMatrix4D& BuildRotation(const YawPitchRoll& angles)
	{
		AffineMatrix4D::BuildRotation(angles);
		return *this;
	}
	LinearMatrix4D& BuildRotation(const UnitQuaternion& q)
	{
		AffineMatrix4D::BuildRotation(q);
		return *this;
	}
	LinearMatrix4D& BuildRotation(const Vector3D& v)
	{
		AffineMatrix4D::BuildRotation(v);
		return *this;
	}
	LinearMatrix4D& BuildTranslation(const Point3D& p)
	{
		AffineMatrix4D::BuildTranslation(p);
		return *this;
	}
	...
	//
	LinearMatrix4D& Multiply(const LinearMatrix4D& m1, const LinearMatrix4D& m2)
	{
		AffineMatrix4D::Multiply(m1, m2);
		return *this;
	}
	LinearMatrix4D& operator*=(const LinearMatrix4D& M)
	{
		LinearMatrix4D src(*this);
	...
	// Matrix4D Inversion
	//
	LinearMatrix4D& Invert(const LinearMatrix4D& Source);
	LinearMatrix4D& Invert()
	{
		LinearMatrix4D src(*this);
		return Invert(src);
	}
