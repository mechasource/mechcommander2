...
HRESULT __stdcall wLoad(LPDIRECT3DDEVICE7 d3dDevice7, LPDIRECTDRAWSURFACE7 lpDestTex,PPOINT lpDestPoint, LPDIRECTDRAWSURFACE7 lpSrcTex, PRECT lprcSrcRect, uint32_t dwFlags);
...
HRESULT __stdcall wLock(LPDIRECTDRAWSURFACE7 lpdd7, PRECT lpDestRect,LPDDSURFACEDESC2 lpDDSurfaceDesc, uint32_t dwFlags, HANDLE hEvent);
HRESULT __stdcall wUnlock(LPDIRECTDRAWSURFACE7 lpdds7, PRECT lprect);
HRESULT __stdcall wLock(LPDIRECTDRAWSURFACE lpdds, PRECT lpDestRect,LPDDSURFACEDESC lpDDSurfaceDesc, uint32_t dwFlags, HANDLE hEvent);
HRESULT __stdcall wUnlock(LPDIRECTDRAWSURFACE lpdds, PRECT lprect);
...
HRESULT __stdcall wBlt(LPDIRECTDRAWSURFACE7 lpdd7, PRECT lpDestRect,LPDIRECTDRAWSURFACE7 lpDDSrcSurface, PRECT lpSrcRect, uint32_t dwFlags, LPDDBLTFX lpDDBltFx);
HRESULT __stdcall wBltFast(LPDIRECTDRAWSURFACE7 lpdd7, uint32_t dwX, uint32_t dwY,LPDIRECTDRAWSURFACE7 lpDDSrcSurface, PRECT lpSrcRect, uint32_t dwTrans);
...
HRESULT __stdcall wGetAvailableVidMem(LPDIRECTDRAW7 lpdd7, LPDDSCAPS2 lpDDSCaps2, pulong32_t lpdwTotal, pulong32_t lpdwFree);
HRESULT __stdcall wGetFourCCCodes(LPDIRECTDRAW7 lpdd7, pulong32_t lpNumCodes, pulong32_t lpCodes);
...
HRESULT __stdcall wCreateAddress(IDirectPlayLobby3A* dplobby3, REFGUID guidSP, REFGUID guidDataType,
	LPCVOID lpData, uint32_t dwDataSize, PVOID lpAddress, puint32_t lpdwAddressSize);
...
HRESULT __stdcall wGetConnectionSettings(
	IDirectPlayLobby3A* dplobby3, uint32_t dwAppID, PVOID lpData, puint32_t lpdwDataSize);
HRESULT __stdcall wReceiveLobbyMessage(IDirectPlayLobby3A* dplobby3, uint32_t dwFlags,
	uint32_t dwAppID, puint32_t lpdwMessageFlags, PVOID lpData, puint32_t lpdwDataSize);
HRESULT __stdcall wRegisterApplication(
	IDirectPlayLobby3A* dplobby3, uint32_t dwFlags, LPDPAPPLICATIONDESC lpAppDesc);
HRESULT __stdcall wRunApplication(IDirectPlayLobby3A* dplobby3, uint32_t dwFlags,
	puint32_t lpdwAppID, LPDPLCONNECTION lpConn, HANDLE hReceiveEvent);
HRESULT __stdcall wSendLobbyMessage(IDirectPlayLobby3A* dplobby3, uint32_t dwFlags,
	uint32_t dwAppID, PVOID lpData, uint32_t dwDataSize);
HRESULT __stdcall wSetConnectionSettings(
	IDirectPlayLobby3A* dplobby3, uint32_t dwFlags, uint32_t dwAppID, LPDPLCONNECTION lpConn);
HRESULT __stdcall wSetLobbyMessageEvent(
	IDirectPlayLobby3A* dplobby3, uint32_t dwFlags, uint32_t dwAppID, HANDLE hReceiveEvent);
...
HRESULT __stdcall wConnectEx(
	IDirectPlayLobby3A* dplobby3, uint32_t dwFlags, REFIID riid, PVOID* lplpDP, IUnknown* pUnk);
#endif
