...
DECLARE_INTERFACE_(IXAudio2, IUnknown)
{
	...
	(THIS_ _In_ IXAudio2EngineCallback * pCallback) PURE;
	...
	(THIS_ _Outptr_ IXAudio2SourceVoice * *ppSourceVoice,
	...
	(THIS_ _Outptr_ IXAudio2SubmixVoice * *ppSubmixVoice,
	...
	(THIS_ _Outptr_ IXAudio2MasteringVoice * *ppMasteringVoice,
	...
	(THIS_ UINT32 OperationSet) PURE;
	...
	(THIS_ _Out_ XAUDIO2_PERFORMANCE_DATA * pPerfData) PURE;
	...
	(THIS_ _In_opt_ const XAUDIO2_DEBUG_CONFIGURATION* pDebugConfiguration,
...
DECLARE_INTERFACE_(IXAudio2Extension, IUnknown)
{
	...
	//
	STDMETHOD_(void, GetProcessingQuantum)
	(THIS_ _Out_ UINT32 * quantumNumerator, _Out_range_(!=, 0) UINT32 * quantumDenominator);
	...
	//
	STDMETHOD_(void, GetProcessor)
	(THIS_ _Out_range_(!=, 0) XAUDIO2_PROCESSOR * processor);
};
...
#define Declare_IXAudio2Voice_Methods()                                               \
    ...
    */                                           \
	...
	(THIS_ _Out_ XAUDIO2_VOICE_DETAILS * pVoiceDetails) PURE;                         \
                                                                                      \
    ...
    */                                           \
	...
	(THIS_ _In_opt_ const XAUDIO2_VOICE_SENDS* pSendList) PURE;                       \
                                                                                      \
    ...
    */                                            \
	...
	(THIS_ _In_opt_ const XAUDIO2_EFFECT_CHAIN* pEffectChain) PURE;                   \
                                                                                      \
    ...
    */                                            \
	...
	(THIS_ UINT32 EffectIndex, _Out_ BOOL * pEnabled) PURE;                           \
                                                                                      \
    ...
    */                                       \
	...
	(THIS_ _In_ const XAUDIO2_FILTER_PARAMETERS* pParameters,                         \
		UINT32 OperationSet X2DEFAULT(XAUDIO2_COMMIT_NOW)) PURE;                      \
                                                                                      \
    ...
    */                                       \
	...
	(THIS_ _Out_ XAUDIO2_FILTER_PARAMETERS * pParameters) PURE;                       \
                                                                                      \
    ...
    */                                 \
	...
	(THIS_ _In_opt_ IXAudio2Voice * pDestinationVoice,                                \
    ...
    */                                                 \
	...
	(THIS_ _Out_ float* pVolume) PURE;                                                \
                                                                                      \
    ...
    */                                         \
	...
	(THIS_ UINT32 Channels, _In_reads_(Channels) const float* pVolumes,               \
		UINT32 OperationSet X2DEFAULT(XAUDIO2_COMMIT_NOW)) PURE;                      \
                                                                                      \
    ...
    */                                         \
	...
	(THIS_ UINT32 Channels, _Out_writes_(Channels) float* pVolumes) PURE;             \
                                                                                      \
...
DECLARE_INTERFACE_(IXAudio2SourceVoice, IXAudio2Voice)
{
	...
	//
	STDMETHOD(Start)
	(THIS_ UINT32 Flags X2DEFAULT(0), UINT32 OperationSet X2DEFAULT(XAUDIO2_COMMIT_NOW)) PURE;
	...
	(THIS_ _In_ const XAUDIO2_BUFFER* pBuffer, _In_opt_ const XAUDIO2_BUFFER_WMA* pBufferWMA X2DEFAULT(NULL)) PURE;
	...
	//
	STDMETHOD(ExitLoop)
	(THIS_ UINT32 OperationSet X2DEFAULT(XAUDIO2_COMMIT_NOW)) PURE;
	...
	(THIS_ _Out_ XAUDIO2_VOICE_STATE * pVoiceState, UINT32 Flags X2DEFAULT(0)) PURE;
	...
	(THIS_ UINT32 NewSourceSampleRate) PURE;
};
...
DECLARE_INTERFACE_(IXAudio2MasteringVoice, IXAudio2Voice)
{
	...
	//
	STDMETHOD(GetChannelMask)
	(THIS_ _Out_ DWORD * pChannelmask) PURE;
};
