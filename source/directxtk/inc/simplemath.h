...
struct Vector2 : public DirectX::XMFLOAT2
{
	...
	constexpr explicit Vector2(float ix) noexcept
		: DirectX::XMFLOAT2(ix, ix)
	{
	}
	constexpr Vector2(float ix, float iy) noexcept
		: DirectX::XMFLOAT2(ix, iy)
	{
	}
...
struct Matrix : public DirectX::XMFLOAT4X4
{
	...
	Matrix(const DirectX::XMFLOAT4X4& M) noexcept
	{
		memcpy_s(this, sizeof(float) * 16, &M, sizeof(DirectX::XMFLOAT4X4));
	}
...
struct Plane : public DirectX::XMFLOAT4
{
	...
	Plane(const Vector3& normal, float d) noexcept
		: DirectX::XMFLOAT4(normal.x, normal.y, normal.z, d)
	{
	}
	...
	Plane(const DirectX::XMFLOAT4& p) noexcept
	{
		this->x = p.x;
		this->y = p.y;
		this->z = p.z;
...
struct Quaternion : public DirectX::XMFLOAT4
{
	...
	Quaternion(const Vector3& v, float scalar) noexcept
		: DirectX::XMFLOAT4(v.x, v.y, v.z, scalar)
	{
	}
	...
	Quaternion(const DirectX::XMFLOAT4& q) noexcept
	{
		this->x = q.x;
		this->y = q.y;
		this->z = q.z;
...
struct Color : public DirectX::XMFLOAT4
{
	...
	Color(const DirectX::XMFLOAT4& c) noexcept
	{
		this->x = c.x;
		this->y = c.y;
		this->z = c.z;
...
template <>
struct less<directxtk::SimpleMath::Rectangle>
{
...
template <>
struct less<directxtk::SimpleMath::Vector2>
{
...
template <>
struct less<directxtk::SimpleMath::Vector3>
{
...
template <>
struct less<directxtk::SimpleMath::Vector4>
{
...
template <>
struct less<directxtk::SimpleMath::Matrix>
{
...
template <>
struct less<directxtk::SimpleMath::Plane>
{
...
template <>
struct less<directxtk::SimpleMath::Quaternion>
{
...
template <>
struct less<directxtk::SimpleMath::Color>
{
...
template <>
struct less<directxtk::SimpleMath::Ray>
{
...
template <>
struct less<directxtk::SimpleMath::Viewport>
{
