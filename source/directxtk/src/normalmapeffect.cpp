...
public:
	...
	int GetPipelineStatePermutation(bool vertexcolourEnabled, bool biasedVertexNormals) const;
	...
	sampler{}
{
	...
	_ASSERT(sp >= 0 && sp < NormalMapEffectTraits::ShaderPermutationCount);
	...
	_ASSERT(vi >= 0 && vi < NormalMapEffectTraits::VertexShaderCount);
	...
	_ASSERT(pi >= 0 && pi < NormalMapEffectTraits::PixelShaderCount);
...
int
NormalMapEffect::Impl::GetPipelineStatePermutation(bool vertexcolourEnabled, bool biasedVertexNormals) const
{
	int permutation = 0;
...
void
NormalMapEffect::Impl::Apply(_In_ ID3D12GraphicsCommandList* commandList)
{
...
// IEffect methods
void
NormalMapEffect::Apply(_In_ ID3D12GraphicsCommandList* commandList)
{
...
// Camera settings
void XM_CALLCONV
NormalMapEffect::SetWorld(FXMMATRIX value)
{
...
void XM_CALLCONV
NormalMapEffect::SetView(FXMMATRIX value)
{
...
void XM_CALLCONV
NormalMapEffect::SetProjection(FXMMATRIX value)
{
...
void XM_CALLCONV
NormalMapEffect::SetMatrices(FXMMATRIX world, CXMMATRIX view, CXMMATRIX projection)
{
...
// Material settings
void XM_CALLCONV
NormalMapEffect::SetDiffusecolour(FXMVECTOR value)
{
...
void XM_CALLCONV
NormalMapEffect::SetEmissivecolour(FXMVECTOR value)
{
...
void XM_CALLCONV
NormalMapEffect::SetSpecularcolour(FXMVECTOR value)
{
...
void
NormalMapEffect::SetSpecularPower(float value)
{
...
void
NormalMapEffect::DisableSpecular()
{
...
void
NormalMapEffect::SetAlpha(float value)
{
...
void XM_CALLCONV
NormalMapEffect::SetcolourAndAlpha(FXMVECTOR value)
{
	pImpl->lights.diffusecolour = value;
...
// Light settings
void XM_CALLCONV
NormalMapEffect::SetAmbientLightcolour(FXMVECTOR value)
{
...
void
NormalMapEffect::SetLightEnabled(int whichLight, bool value)
{
...
void XM_CALLCONV
NormalMapEffect::SetLightDirection(int whichLight, FXMVECTOR value)
{
...
// Fog settings.
void
NormalMapEffect::SetFogStart(float value)
{
...
void
NormalMapEffect::SetFogEnd(float value)
{
	pImpl->fog.end = value;
...
void XM_CALLCONV
NormalMapEffect::SetFogcolour(FXMVECTOR value)
{
...
// Texture settings.
void
NormalMapEffect::SetTexture(D3D12_GPU_DESCRIPTOR_HANDLE srvDescriptor, D3D12_GPU_DESCRIPTOR_HANDLE samplerDescriptor)
{
...
void
NormalMapEffect::SetNormalTexture(D3D12_GPU_DESCRIPTOR_HANDLE srvDescriptor)
{
	pImpl->normal = srvDescriptor;
}

void
NormalMapEffect::SetSpecularTexture(D3D12_GPU_DESCRIPTOR_HANDLE srvDescriptor)
{
