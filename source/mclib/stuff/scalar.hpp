...
inline float Sin(float v) { return static_cast<float>(sin(v)); }

inline float Cos(float v) { return static_cast<float>(cos(v)); }

inline float Tan(float v) { return static_cast<float>(tan(v)); }
