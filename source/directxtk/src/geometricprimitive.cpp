...
public:
	Impl() noexcept :
		mIndexCount(0), mVertexBufferView{}, mIndexBufferView{} {}
...
void
GeometricPrimitive::Impl::Initialize(
...
GeometricPrimitive::Impl::LoadStaticBuffers(
	ID3D12Device* device,
...
// Draws the primitive.
_Use_decl_annotations_ void
GeometricPrimitive::Impl::Draw(ID3D12GraphicsCommandList* commandList) const
{
...
// Public entrypoints.
_Use_decl_annotations_ void
GeometricPrimitive::LoadStaticBuffers(ID3D12Device* device, ResourceUploadBatch& resourceUploadBatch)
{
	pImpl->LoadStaticBuffers(device, resourceUploadBatch);
}

_Use_decl_annotations_ void
GeometricPrimitive::Draw(ID3D12GraphicsCommandList* commandList) const
{
...
std::unique_ptr<GeometricPrimitive>
GeometricPrimitive::CreateGeoSphere(
	float diameter,
	size_t tessellation,
	bool rhcoords,
	_In_opt_ ID3D12Device* device)
...
std::unique_ptr<GeometricPrimitive>
GeometricPrimitive::CreateCylinder(
	float height,
	float diameter,
	size_t tessellation,
	bool rhcoords,
...
std::unique_ptr<GeometricPrimitive>
GeometricPrimitive::CreateTetrahedron(
	float size,
	bool rhcoords,
	_In_opt_ ID3D12Device* device)
{
...
std::unique_ptr<GeometricPrimitive>
GeometricPrimitive::CreateOctahedron(
	float size,
	bool rhcoords,
	_In_opt_ ID3D12Device* device)
{
...
std::unique_ptr<GeometricPrimitive>
GeometricPrimitive::CreateDodecahedron(
	float size,
	bool rhcoords,
	_In_opt_ ID3D12Device* device)
{
...
std::unique_ptr<GeometricPrimitive>
GeometricPrimitive::CreateIcosahedron(
	float size,
	bool rhcoords,
	_In_opt_ ID3D12Device* device)
{
...
std::unique_ptr<GeometricPrimitive>
GeometricPrimitive::CreateTeapot(
	float size,
	size_t tessellation,
	bool rhcoords,
	_In_opt_ ID3D12Device* device)
