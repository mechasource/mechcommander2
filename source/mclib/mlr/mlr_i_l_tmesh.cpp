...
void MLR_I_L_TMesh::InitializeClass()
{
	...
	DefaultData =
		new ClassData(MLR_I_L_TMeshClassID, "MidLevelRenderer::MLR_I_L_TMesh",
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//
MLR_I_L_TMesh* MLR_I_L_TMesh::Make(
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//
void MLR_I_L_TMesh::Save(Stuff::MemoryStream* stream)
{
	// Check_Object(this);
	Check_Object(stream);
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//
MLRShape* MidLevelRenderer::CreateIndexedTriIcosahedron_Color_Lit(
	IcoInfo& icoInfo, MLRState* state)
{
	...
	for (k = 0; k < 20; k++)
	{
		...
		else
		{
			for (i = 0; i < uniquePoints; i++)
			{
				colors[i] = RGBAColor((1.0f + coords[i].x) / 2.0f,
