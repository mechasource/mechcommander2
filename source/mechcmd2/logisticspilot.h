...
public:
	...
	const EString&	 getAudio(void) const
	{
		return audio;
	}
	const EString& getVideo(void) const
	{
		return video;
	}
	...
	const EString& getIconFile(void) const
	{
		return iconFile;
	}
	...
	bool		isAvailable()
	{
		return (bAvailable && !bDead);    // depends on purchasing file .... maybe should put dead checks and stuff
	}
