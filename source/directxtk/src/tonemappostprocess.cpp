...
void
ToneMapPostProcess::Impl::Process(_In_ ID3D12GraphicsCommandList* commandList)
{
...
void
ToneMapPostProcess::Process(_In_ ID3D12GraphicsCommandList* commandList)
{
...
// Properties
void
ToneMapPostProcess::SetHDRSourceTexture(D3D12_GPU_DESCRIPTOR_HANDLE srvDescriptor)
{
	pImpl->texture = srvDescriptor;
}

void
ToneMapPostProcess::SetExposure(float exposureValue)
{
...
void
ToneMapPostProcess::SetST2084Parameter(float paperWhiteNits)
{
