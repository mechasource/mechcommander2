...
class ParticleCloud__Specification : public Effect__Specification
{
  ...
  public:
	...
	SeededCurveOf<ConstantCurve, LinearCurve, Curve::e_ConstantLinearType>
		m_pEtherVelocityX, m_pEtherVelocityY, m_pEtherVelocityZ;
	SeededCurveOf<SplineCurve, LinearCurve, Curve::e_SplineLinearType>
		m_pAccelerationX, m_pAccelerationY, m_pAccelerationZ;
	SeededCurveOf<ComplexCurve, ComplexCurve, Curve::e_ComplexComplexType>
		m_pDrag;
...
class _declspec(novtable) ParticleCloud : public Effect
{
  ...
  protected:
	...
	virtual bool AnimateParticle(uint32_t index,
		const Stuff::LinearMatrix4D* world_to_new_local, Stuff::Time till) = 0;
